  ...
  return (
    <section>
      <div className="text-center m-4">
        <h2 className="text-center hover:underline" onClick={() => handleFiltreCategorie('')} >TOUTES NOS RECETTES :</h2>
        {!homeLocation && (        
      ...
      <NavLink to="/search"><h4 className="p-4 my-8 text-center font-bold hover:underline hover:text-white bg-blue-600 rounded-xl w-2/12 mx-auto">Voir toutes les recettes </h4></NavLink>
    </section>
  );
};
