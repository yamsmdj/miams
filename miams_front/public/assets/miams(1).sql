...
--
-- Hôte : 127.0.0.1:3306
-- Généré le : mer. 24 avr. 2024 à 21:50
...
INSERT INTO `recette` (`id`, `chef_id`, `title`, `description`, `time`, `created_at`, `categorie_id`, `picture`) VALUES
(1, NULL, 'Salade Cesar', 'Tres bonne pour l\'été fraiche et appetissante', 20, '2024-04-20 17:25:56', 1, NULL),
...
(5, NULL, 'Lasagnes à la bolognaise', ' la bolognaise est parfaite pour découvrir les légumineuses. Enrobées de sauce tomate, les lentilles se transforment en une sauce fondante et végétarienne ! »', 125, '2024-04-24 21:42:39', 2, NULL),
(6, NULL, 'Gâteau au chocolat fondant rapide', '« Pour aller plus vite, pour faire fondre le chocolat et le beurre, je mets le tout dans un bol coupé en carrés au micro-ondes.', 40, '2024-04-24 21:47:29', 3, NULL);
